...
import { create } from '../../actions/translate';
...
const CreateTramslateRoom = ({ classes, setAlert, create, history }) => {
...
export default connect(null, {
    setAlert,
    create,
})(withStyles(styles)(CreateTramslateRoom));
