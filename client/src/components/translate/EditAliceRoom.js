...
const EditAliceRoom = ({ classes, setAlert, updateClub, history, match }) => {
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        if (isValid()) {
            updateClub(match.params.id, userData, history);
        }
    };
...
export default connect(null, {
    setAlert,
    updateClub,
})(withStyles(styles)(EditAliceRoom));
