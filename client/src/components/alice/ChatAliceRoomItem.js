...
import { addClub, deleteClub } from '../../actions/club';
...
const ChatAliceRoomItem = ({ club: { _id, title, body, date, classmonitor }, user, history, addClub, socket, deleteClub }) => {
...
export default connect(null, { addClub, deleteClub })(withRouter(ChatAliceRoomItem));
