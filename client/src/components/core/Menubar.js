...
const Menubar = ({ auth: { isAuthenticated, loading, user }, logout, history }) => {
    const logoutOnclick = () => {
        logout(history);
    };
    ...
    return (
        <div className={classes.grow}>
            ...
            {renderMobileMenu}
            {isAuthenticated ? renderMenu : AuthrenderMenu}
        </div>
    );
};
...
export default connect(mapStateToProps, { logout })(withRouter(Menubar));
